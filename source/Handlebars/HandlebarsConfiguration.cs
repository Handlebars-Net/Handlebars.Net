...
namespace HandlebarsDotNet
{
    public class HandlebarsConfiguration
    {
        ...
        public IDictionary<string, HandlebarsReturnHelper> ReturnHelpers { get; private set; }
        ...
        public HandlebarsConfiguration()
        {
            ...
            this.ReturnHelpers = new Dictionary<string, HandlebarsReturnHelper>(StringComparer.OrdinalIgnoreCase);
